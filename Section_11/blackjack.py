...
def reset_game():
    global deck, dealer_card_frame, player_card_frame, dealer_hand, player_hand
    deck = list(cards)
    random.shuffle(deck)
    dealer_hand = []
    player_hand = []
...
def play():
    global mainWindow, result_text, result, card_frame, dealer_score_label, dealer_card_frame, player_card_frame
    global player_score_label, cards, deck
