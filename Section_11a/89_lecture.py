...
mainWindow.columnconfigure(3, weight=10000)
mainWindow.columnconfigure(4, weight=10000)
...
daySpinner = tkinter.Spinbox(dateFrame, width=5, values=tuple(range(1, 31)))
monthSpinner = tkinter.Spinbox(dateFrame, width=5, from_=1, to=12)
yearSpinner = tkinter.Spinbox(dateFrame, width=5, from_=1, to=10000)
